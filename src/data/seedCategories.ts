...
export const SEED_CATEGORIES: SeedCategory[] = [
  ...
  // Game Store (125)
  { id: "games_video",    name: "Video games",       count: 30, storeType: "games", category: "video_games",    prompt: "PS5 game, Xbox game, Nintendo Switch game, PC game, retro game, digital game card, gift card, controller, console" },
  { id: "games_card",     name: "Card games",        count: 25, storeType: "games", category: "card_games",     prompt: "Magic the Gathering booster, Pokemon TCG booster, Yu-Gi-Oh deck, playing cards, Uno, card sleeves, deck box, card binder, starter deck" },
  { id: "games_tabletop", name: "Tabletop & RPG",    count: 25, storeType: "games", category: "tabletop_games", prompt: "D&D handbook, RPG dice set, miniature figure, paint set, miniature brush, battle mat, terrain, RPG starter set, wargame rulebook" },
  { id: "games_puzzles",  name: "Puzzles",           count: 25, storeType: "games", category: "puzzles",        prompt: "1000 piece jigsaw, 2000 piece jigsaw, 3D puzzle, wooden puzzle, escape room puzzle, magnetic puzzle, glow-in-dark puzzle, kids puzzle, mystery puzzle" },
  { id: "games_gear",     name: "Gaming gear",       count: 20, storeType: "games", category: "gaming_gear",    prompt: "gaming headset, gaming mouse, gaming keyboard, gaming chair, controller grip, console stand, game storage, HDMI cable, charging dock, console cooler" },
  // Hunting & Fishing (115)
  { id: "hf_fish_gear",   name: "Fishing gear",      count: 30, storeType: "hunting_fish", category: "fishing_gear",   prompt: "fishing rod, reel, fishing line, tackle box, fishing net, landing net, float, fishing vest, fishing hat, fish finder, rod holder, fishing chair" },
  { id: "hf_hunt_gear",   name: "Hunting gear",      count: 25, storeType: "hunting_fish", category: "hunting_gear",   prompt: "hunting bow, crossbow, arrows, hunting blind, tree stand, decoy, game call, scent blocker, hunting knife, gun cleaning kit, hunting pack" },
  { id: "hf_apparel",     name: "Outdoor apparel",   count: 20, storeType: "hunting_fish", category: "outdoor_apparel", prompt: "waders, rubber boots, camo jacket, camo pants, thermal gloves, fishing vest, beanie, insulated overalls, rain suit, gaiters, face mask" },
  { id: "hf_optics",      name: "Optics & navigation", count: 20, storeType: "hunting_fish", category: "optics_nav", prompt: "binoculars, rifle scope, spotting scope, rangefinder, GPS device, compass, headlamp, trail camera, topographic map, night vision" },
  { id: "hf_bait",        name: "Bait & tackle",     count: 20, storeType: "hunting_fish", category: "bait_tackle",    prompt: "lures, spinners, worms, bait buckets, hooks, sinkers, swivels, leaders, fly fishing flies, crankbaits, soft plastics, live bait" },
  // Musical Instruments (110)
  { id: "mi_string",      name: "String instruments", count: 25, storeType: "music_inst", category: "string_instruments", prompt: "acoustic guitar, electric guitar, bass guitar, classical guitar, violin, viola, cello, ukulele, banjo, mandolin, guitar strings, bow, guitar case" },
  { id: "mi_wind",        name: "Wind instruments",  count: 20, storeType: "music_inst", category: "wind_instruments", prompt: "flute, clarinet, saxophone, trumpet, trombone, recorder, harmonica, oboe, reeds, mouthpiece, instrument cleaning kit" },
  { id: "mi_perc",        name: "Percussion",        count: 20, storeType: "music_inst", category: "percussion",     prompt: "drum kit, snare drum, cymbal, drumsticks, bongo, cajon, tambourine, djembe, electronic drum pad, drum stool, drum head" },
  { id: "mi_keys",        name: "Keyboards & piano", count: 20, storeType: "music_inst", category: "keyboards_piano", prompt: "digital piano, MIDI keyboard, synthesizer, keyboard stand, sustain pedal, keyboard bench, piano cover, keyboard bag, keyboard amp" },
  { id: "mi_access",      name: "Music accessories", count: 25, storeType: "music_inst", category: "music_accessories", prompt: "metronome, tuner, music stand, sheet music, headphones, amplifier, cable, strap, capo, picks, rosin, instrument case, microphone" },
  // Fabric & Sewing (95)
  { id: "fab_fabrics",    name: "Fabrics",           count: 30, storeType: "fabric", category: "fabrics", prompt: "cotton fabric, linen fabric, wool fabric, silk fabric, denim, felt, fleece, lace, satin, canvas, jersey knit, upholstery fabric" },
  { id: "fab_yarn",       name: "Yarn & knitting",   count: 25, storeType: "fabric", category: "yarn_knitting", prompt: "wool yarn, cotton yarn, acrylic yarn, knitting needles, crochet hook, knitting pattern, stitch markers, yarn bowl, tapestry needle" },
  { id: "fab_tools",      name: "Sewing tools",      count: 20, storeType: "fabric", category: "sewing_tools", prompt: "sewing machine, sewing scissors, pinking shears, measuring tape, seam ripper, iron, ironing board, pincushion, rotary cutter, cutting mat, fabric marker" },
  { id: "fab_notions",    name: "Buttons & notions", count: 20, storeType: "fabric", category: "notions", prompt: "buttons, zippers, snaps, hook and eye, elastic, ribbon, bias tape, interfacing, velcro, thread spool, needles, safety pins, embroidery floss" },
];
