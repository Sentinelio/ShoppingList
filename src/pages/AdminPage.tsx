        ...
        {tab === "roadmap" && (
          <div>
            ...
            {[
              ...
              {title:"🔴 Siguiente",color:"#ff5c5c",items:[[false,"Autocompletado al añadir productos (sugerencias desde el diccionario)"],[false,"Buscar dentro de una lista"],[false,"Modo compra (estante GRANDE)"],[false,"Export WhatsApp bilingüe"],[false,"Bulk add desde WhatsApp"],[false,"Diccionario fuzzy (plurales, typos)"]]},
